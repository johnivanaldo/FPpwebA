        ...
        <table class="table table-striped" border="1">
            ...
            <tbody>
                <?php
                    ...
                    $sql = "SELECT a.nama, sa.url FROM assignments a LEFT JOIN submissions_assignments sa ON sa.assignment_id = a.id AND sa.student_id = ?";
                    ...
                    if ($stmt = mysqli_prepare($link, $sql)) {
                        ...
                        if (mysqli_stmt_execute($stmt)) {
                            ...
                            mysqli_stmt_bind_result($stmt, $assignment_name, $assignment_url);
                            ...
                            while (mysqli_stmt_fetch($stmt)) {
                                ...
                                if (empty($assignment_url)) {
                                    ...
                                    echo "<td>Hasil pekerjaan anda belum dinilai</td>";
                                }
